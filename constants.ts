...
export const INITIAL_STYLE_MAP: Record<ScheduleType, { bgColor: string; textColor: string }> = {
    [ScheduleType.SHIFT1]: { bgColor: '#166534', textColor: '#dcfce7' },
    [ScheduleType.SHIFT2]: { bgColor: '#276339', textColor: '#dcfce7' },
    [ScheduleType.OFF]: { bgColor: '#4b5563', textColor: '#9ca3af' },
    [ScheduleType.VACATION]: { bgColor: '#1e40af', textColor: '#bfdbfe' },
    [ScheduleType.COMP_OFF]: { bgColor: '#854d0e', textColor: '#fef9c3' },
    [ScheduleType.COVERAGE_GAP]: { bgColor: '#b91c1c', textColor: '#ffffff' },
};