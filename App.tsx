...
// import { generateRoster } from './services/rosterService';
// import { exportToImage, exportToExcel } from './services/exportService';
// import { Employee, Roster, CoverageIssue } from './types';
// import { INITIAL_EMPLOYEES, INITIAL_STYLE_MAP } from './constants';
// import { LogoIcon, LoadingIcon } from './components/Icons';
...
//     const [isLoading, setIsLoading] = useState(false);
//     const [teamAShift, setTeamAShift] = useState<1 | 2>(1);
//     const [styleMap, setStyleMap] = useState(INITIAL_STYLE_MAP);
...
//                 const index = newList.findIndex(e => e.id === upd.id);
//                 if (index !== -1) {
//                     newList[index] = upd;
//                 } else {
//                     newList.push(upd);
                        ...
                        {!isLoading && roster && (
                             <div className="bg-gray-800 p-6 rounded-lg shadow-lg">
                                ...
                                <RosterTable
                                    ...
                                    coverageIssues={coverageIssues}
                                    styleMap={styleMap}
                                    teamAShift={teamAShift} // Pass teamAShift prop
                                />
                                {coverageIssues.length > 0 && (
                                    <div className="mt-6 p-4 bg-red-900 border border-red-700 rounded-lg">
                                        <h3 className="font-bold text-lg text-red-200">Coverage Warning!</h3>
